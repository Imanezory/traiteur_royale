...
<body class="text-black">
  <header class='flex border-b sticky top-0 bg-white font-sans min-h-[70px] tracking-wide relative z-50'>
    <div class='flex flex-wrap items-center justify-around px-10 py-3 gap-4 w-full'>
      ...
      <div id="collapseMenu"
        ...
        <ul class="lg:flex lg:gap-x-10 lg:px-10 lg:space-y-0 max-lg:space-y-3 max-lg:fixed max-lg:bg-white max-lg:w-full max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50">
          ...
          <li class="max-lg:border-b max-lg:py-3">
            <a href="<?= base_url('acceuil'); ?>" class="text-[15px] text-[#ff9d6e] font-bold block">Acceuil</a>
          </li>
          <li class="group max-lg:border-b max-lg:py-3 relative">
            <a href="<?= base_url('plats'); ?>" class="hover:text-[#ff9d6e] text-black text-[15px] font-bold lg:hover:fill-[#ff9d6e] block">
              Nos Plats
            ...
            <ul class="absolute shadow-lg bg-white space-y-3 lg:top-5 max-lg:top-8 -left-6 min-w-[250px] z-50 max-h-0 overflow-hidden group-hover:opacity-100 group-hover:max-h-[700px] px-6 group-hover:pb-4 group-hover:pt-6 transition-all duration-500">
              <li class="border-b py-2 "><a href="javascript:void(0)" class="hover:text-[#ff9d6e] text-black text-[15px] font-bold block">Mon Petit-Déjeuner</a></li>
              <li class="border-b py-2 "><a href="javascript:void(0)" class="hover:text-[#ff9d6e] text-black text-[15px] font-bold block">Mon Menu</a></li>
              <li class="border-b py-2 "><a href="javascript:void(0)" class="hover:text-[#ff9d6e] text-black text-[15px] font-bold block">Mon Buffet</a></li>
              <li class="border-b py-2 "><a href="javascript:void(0)" class="hover:text-[#ff9d6e] text-black text-[15px] font-bold block">Mon Mariage</a></li>
            </ul>
          </li>
          <li class="max-lg:border-b max-lg:py-3">
            <a href="<?= base_url('services'); ?>" class="hover:text-[#ff9d6e] text-black text-[15px] font-bold block">Nos Services</a>
          </li>
          <li class="max-lg:border-b max-lg:py-3">
            <a href="<?= base_url('a-propos'); ?>" class="hover:text-[#ff9d6e] text-black text-[15px] font-bold block">À propos</a>
          </li>
          <li class="max-lg:border-b max-lg:py-3">
            <a href="<?= base_url('contact'); ?>" class="hover:text-[#ff9d6e] text-black text-[15px] font-bold block">Contact</a>
          </li>
      ...
      <div id="sidebar" class="sidebar  fixed top-0 left-0 w-64 bg-[#072b31] text-white h-full z-40 transform -translate-x-full transition-transform duration-300">
        <ul class="space-y-4 p-6">
          <li><a href="acceuil" class="block py-2 px-4 hover:bg-white hover:text-black">Acceuil</a></li>
          <li><a href="#" class="block py-2 px-4 hover:bg-white hover:text-black">Nos Plats</a></li>
          <li><a href="services" class="block py-2 px-4 hover:bg-white hover:text-black">Nos Services</a></li>
          <li><a href="javascript:void(0)" class="block py-2 px-4 hover:bg-white hover:text-black">Réservation</a></li>
          <li><a href="a-propos" class="block py-2 px-4 hover:bg-white hover:text-black">À propos</a></li>
          <li><a href="contact" class="block py-2 px-4 hover:bg-white hover:text-black">Contact</a></li>
          <?php if ($session->get('logged_in')): ?>
            <li><a href="" class="block py-2 px-4 hover:bg-white hover:text-black">Mon compte</a></li>
            <li><a href="" class="block py-2 px-4 hover:bg-white hover:text-black">Se déconnecter</a></li>

            </li>
          <?php else: ?>
            <li><a href="" class="block py-2 px-4 hover:bg-white hover:text-black">Se connecter</a></li>
          <?php endif; ?>
        </ul>
      </div>
    </div>
