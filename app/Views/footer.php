...
<footer
  ...
  <div class="mx-6 py-10 text-center md:text-left">
    <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
      ...
      <div class="">
      <img src="<?= base_url('assets/images/logo/Logo.png'); ?>" alt="logo" class='w-24 -ml-6' />
        <p>
        Des repas délicieux et personnalisés pour vos événements.</p>
        </p>
      </div>
      <div>
        <h6
        ...
        <p class="mb-4">
          <a href="plats">Mon Petit-Déjeuner</a>
        </p>
        <p class="mb-4">
          <a href="plats">Mon Buffet</a>
        </p>
        <p class="mb-4">
          <a href="plats">Mon Menu</a>
        </p>
        <p>
          <a href="plats">Mon mariage</a>
        </p>
      </div>
  ...
  <div class="bg-[#072b31] text-white p-6 text-center">
